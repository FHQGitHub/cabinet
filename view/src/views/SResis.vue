 <template>
  <div>
    <h1>This is resistance search page</h1>
    <el-table :data="tableData" border style="width:59%;margin:auto">
      ...
      <el-table-column prop="address" label="所在位置" width="180"></el-table-column>
    </el-table>
  </div>
</template>
